...
pretrained_model = torch.load("pretrained_model_covid19.pth")
...
trainer = pl.Trainer(accelerator="gpu", log_every_n_steps=20, auto_lr_find=False,
                     ...
                     enable_progress_bar=True, fast_dev_run=False, max_epochs=200)

trainer.fit(model, trainloader, testloader)

Save_path = os.path.join("SSL_FineTuned_Models","SSL_finetuned_covid19.pth")
