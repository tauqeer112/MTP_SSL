...
pretrained_model = torch.load("SSL_HAM10000.pth")
...
model = TransferLearning(7, learning_rate=1e-5)
...
Save_path = os.path.join("SSL_FineTuned_Models","SSL_Finetuned_HAM10000.pth")
